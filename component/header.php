  ...
  <header class="header__area-3">
    <div class="header__inner-3">
      <div class="header__logo-2">
        <a href="index.html" class="logo-dark"><img src="assets/imgs/logo/CGB-Studos-logo.png" alt="Site Logo"></a>
            ...
            <ul class="mega-menu">
              ...
              <li>
                ...
                <ul>
                  ...
                  <li><a href="index-9.html">portfolio showcase</a></li>
    ...
    <div class="offcanvas__body">
      <div class="offcanvas__left">
        <div class="offcanvas__logo">
          <a href="index.html"><img src="assets/imgs/logo/CGB-Studos-logo.png" alt="Offcanvas Logo"></a>
        </div>
        ...
        <div class="offcanvas__menu-wrapper">
          <nav class="offcanvas__menu">
            <ul class="menu-anim">
              <li><a>home</a>
                <ul>
                  <li><a href="index-2.html">Digital Maketing</a></li>
                  ...
                  <li><a href="index-11.html">showcase slider</a></li>
                  <li><a href="index-18.html">Interactive hover showcase</a></li>
                </ul>
              </li>
              <li>
                <a>woocomerce</a>
